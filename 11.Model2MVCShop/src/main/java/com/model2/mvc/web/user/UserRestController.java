...
public class UserRestController {
	...
	@RequestMapping( value="json/deleteUser/{password}/{userId}", method=RequestMethod.GET )
	public boolean deleteUser( @PathVariable("password") String password, @PathVariable("userId") String userId, HttpSession session ) throws Exception{

		System.out.println("/user/json/deleteUser : GET");
		//Business Logic
